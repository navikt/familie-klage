...
class NyBrevmottakerPersonUtenIdentMapperTest {
    @Nested
    inner class TilDomeneTest {
        ...
        fun `skal mappe til domene`() {
            ...
            // Act
            val nyBrevmottaker = NyBrevmottakerPersonUtenIdentMapper.tilDomene(nyBrevmottakerDto)

            // Assert
            assertThat(nyBrevmottaker.mottakerRolle).isEqualTo(nyBrevmottakerDto.mottakerRolle)

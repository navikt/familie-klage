...
internal class BrevInnholdUtlederTest {
    ...
    inner class LagFormkravAvvistBrev {
        @Test
        fun `brev for avvist formkrav skal ha med info om tilbakebetaling`() {
            // Arrange
            val ident = "123456789"
            val navn = "Navn Navnesen"
        ...
        @Test
        fun `brev for avvist formkrav skal ha med info om sanksjon`() {
            // Arrange
            val ident = "123456789"
            val navn = "Navn Navnesen"
        ...
        @Test
        fun `brev for avvist formkrav skal ha med info om utestengelse`() {
            // Arrange
            val ident = "123456789"
            val navn = "Navn Navnesen"
    ...
    inner class LagHenleggelsesbrevBaksInnhold {
        ...
        fun `skal utlede brev innholde for hengellesesbrev for BA og KS`(
            stønadstype: Stønadstype,
        ) {
            // Arrange
            val ident = "123456789"
        ...
        fun `skal utlede brev innholde for hengellesesbrev for EF`(
            stønadstype: Stønadstype,
        ) {
            // Arrange
            val ident = "123456789"

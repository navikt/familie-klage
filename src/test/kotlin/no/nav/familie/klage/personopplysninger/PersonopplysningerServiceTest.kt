...
internal class PersonopplysningerServiceTest {
    ...
    internal fun `skal mappe til dto`() {
        val personopplysninger = personopplysningerService.hentPersonopplysninger(defaultIdenter.first().ident, fagsak.stønadstype)
    ...
    @Test
    internal fun `skal hente personopplysninger for søker`() {
        val personopplysninger = personopplysningerService.hentPersonopplysningerSøker(behandlingId = UUID.randomUUID())

...
internal class HenleggBehandlingServiceTest {
    ...
    fun setUp() {
        ...
        every { oppgaveTaskService.lagFerdigstillOppgaveForBehandlingTask(any(), any(), any(), any()) } returns mockk()
    ...
    inner class HenleggBehandling {
        ...
        internal fun `skal kunne henlegge behandling`() {
            ...
            verify(exactly = 1) { oppgaveTaskService.lagFerdigstillOppgaveForBehandlingTask(any(), any(), any(), any()) }
        }

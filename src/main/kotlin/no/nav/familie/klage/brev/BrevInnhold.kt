        ...
        return FritekstBrevRequestDto(
            ...
            listOf(
                AvsnittDto(
                    deloverskrift = "",
                    innhold =
                    "Vi har fått klagen din på vedtaket om $stønadstypeVisningsnavn, og kommet frem til at vedtaket ikke endres. NAV Klageinstans skal derfor vurdere saken din på nytt."
                ),
                AvsnittDto(
                    deloverskrift = "",

...
data class NyBrevmottakerPersonUtenIdent(
    ...
    init {
        ...
        require(mottakerRolle != INSTITUSJON) { "Institusjon kan ikke være mottakerrolle for brevmottakerperson uten ident." }
    }
}
...
data class NyBrevmottakerPersonMedIdent(
    ...
    init {
        ...
        require(mottakerRolle != INSTITUSJON) { "Institusjon kan ikke være mottakerrolle for brevmottakerperson med ident." }
    }
}
